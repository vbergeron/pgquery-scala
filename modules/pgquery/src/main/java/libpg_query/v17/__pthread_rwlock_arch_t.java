...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        pg_query_h.C_INT.withName("__readers"),
        pg_query_h.C_INT.withName("__writers"),
        pg_query_h.C_INT.withName("__wrphase_futex"),
        pg_query_h.C_INT.withName("__writers_futex"),
        pg_query_h.C_INT.withName("__pad3"),
        pg_query_h.C_INT.withName("__pad4"),
        pg_query_h.C_INT.withName("__cur_writer"),
        pg_query_h.C_INT.withName("__shared"),
        pg_query_h.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, pg_query_h.C_CHAR).withName("__pad1"),
        pg_query_h.C_LONG.withName("__pad2"),
        pg_query_h.C_INT.withName("__flags"),
