...
public class pg_query_h {
    ...
    static final SymbolLookup SYMBOL_LOOKUP = SymbolLookup.libraryLookup(System.mapLibraryName("pg_query_v17"), LIBRARY_ARENA)
    ...
    private static final int PG_VERSION_NUM = (int)170000L;
    /**
     * {@snippet lang=c :
    ...
    private static class pg_query_normalize_utility {
        public static final FunctionDescriptor DESC = FunctionDescriptor.of(
            PgQueryNormalizeResult.layout(),
            pg_query_h.C_POINTER
        );

        public static final MemorySegment ADDR = pg_query_h.findOrThrow("pg_query_normalize_utility");
     ...
     * }
     */
    public static FunctionDescriptor pg_query_normalize_utility$descriptor() {
        return pg_query_normalize_utility.DESC;
    }
     ...
     * }
     */
    public static MethodHandle pg_query_normalize_utility$handle() {
        return pg_query_normalize_utility.HANDLE;
    }
     ...
     * }
     */
    public static MemorySegment pg_query_normalize_utility$address() {
        return pg_query_normalize_utility.ADDR;
    }
     ...
     * }
     */
    public static MemorySegment pg_query_normalize_utility(SegmentAllocator allocator, MemorySegment input) {
        var mh$ = pg_query_normalize_utility.HANDLE;
        try {
            if (TRACE_DOWNCALLS) {
                traceDowncall("pg_query_normalize_utility", allocator, input);
            }
            return (MemorySegment)mh$.invokeExact(allocator, input);
        } catch (Throwable ex$) {
           throw new AssertionError("should not reach here", ex$);
    ...
    public static MemorySegment PG_MAJORVERSION() {
        class Holder {
            static final MemorySegment PG_MAJORVERSION
                = pg_query_h.LIBRARY_ARENA.allocateFrom("17");
        }
    ...
    public static MemorySegment PG_VERSION() {
        class Holder {
            static final MemorySegment PG_VERSION
                = pg_query_h.LIBRARY_ARENA.allocateFrom("17.0");
        }
