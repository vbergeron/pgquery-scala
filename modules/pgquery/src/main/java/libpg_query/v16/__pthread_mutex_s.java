...
public class __pthread_mutex_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        pg_query_h.C_INT.withName("__lock"),
        pg_query_h.C_INT.withName("__count"),
        pg_query_h.C_INT.withName("__owner"),
        pg_query_h.C_INT.withName("__nusers"),
        pg_query_h.C_INT.withName("__kind"),
        pg_query_h.C_SHORT.withName("__spins"),
        pg_query_h.C_SHORT.withName("__elision"),
