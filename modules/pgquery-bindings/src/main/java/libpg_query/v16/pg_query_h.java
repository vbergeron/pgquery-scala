...
public class pg_query_h {
    ...
    static final SymbolLookup SYMBOL_LOOKUP = SymbolLookup.libraryLookup(System.mapLibraryName("pg_query_v16"), LIBRARY_ARENA)
    ...
    private static final int PG_VERSION_NUM = (int)160001L;
    /**
     * {@snippet lang=c :
    ...
    public static MemorySegment PG_MAJORVERSION() {
        class Holder {
            static final MemorySegment PG_MAJORVERSION
                = pg_query_h.LIBRARY_ARENA.allocateFrom("16");
        }
    ...
    public static MemorySegment PG_VERSION() {
        class Holder {
            static final MemorySegment PG_VERSION
                = pg_query_h.LIBRARY_ARENA.allocateFrom("16.1");
        }
